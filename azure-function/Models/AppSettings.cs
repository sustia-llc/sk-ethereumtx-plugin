...
public class AppSettings
{
    ...
    public static AppSettings LoadSettings()
    {
        try
        {
            ...
            appSettings.Kernel.EtherscanApiKey = GetEtherscanApiKey();
    ...
    /// <summary>
    /// Load the Etherscan API key for the Etherscan endpoint from user secrets.
    /// </summary>
    internal static string GetEtherscanApiKey()
    {
        return System.Environment.GetEnvironmentVariable("etherscanApiKey", EnvironmentVariableTarget.Process)
               ?? throw new InvalidDataException("Invalid etherscan api key in user secrets, please provide configuration settings using instructions in the README.");
    }
}
